...
def main(args) -> None:
    ...
    if args.train:
        (
            ...
            scatter_action_dict,
            scatter_reward_dict,
        ) = qmix.create_agent(params, l_params, n_obs, n_actions, args.train)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="agents/QMIXLearning/config/learning-params.json",
        required=False,
    )
    ...
    parser.add_argument(
        "--logger_params_path",
        type=str,
        default="agents/QMIXLearning/config/logger-params.json",
        required=False,
    )
